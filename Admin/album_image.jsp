<%-- 
    Document   : add_image
    Created on : Dec 29, 2020, 2:21:38 PM
    Author     : Nikhil Vijay
--%>
...
<% 
    ...
    if(email != null && session.getAttribute(email)!= null ){
        if(request.getParameter("id")== null || request.getParameter("album_code")== null) {
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="col-sm-12">
                        ...
                        %>
                        <form method="post" ACTION="image_upload.jsp?album_code=<%=album_code%>" name="uploadForm" ENCTYPE='multipart/form-data'>
                        ...
                        <input type="submit" name="Submit" class="btn btn-danger">
                                    ...
                                    <div class="col-sm-12">
                                        ...
                                        while(rs.next()){  
                                            ...
                                            %>
                                            <tr id="<%=code%>"><td><a href="album.jsp?id=<%=code%>" style="color:black; text-decoration: none"><%=rs.getString("category_name")%></td><td><i class="fa fa-trash" rel="<%=code%>" style="color:red"></i></td></tr>
                                        <%        
                                        }
                                        cn.close();
                                         }
