...
<head>
    ...
    <meta name="edit" content="">

    <title>MP3 Rocker</title>
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
                ...
                <div class="sidebar-brand-text mx-3">MP3 Rocker <sup>2</sup></div>
            </a>
                    ...
                    <input type="submit" class="btn btn-danger">
                                    ...
                                    <div class="col-sm-12">
                                        ...
                                        while(rs.next()){  
                                            ...
                                            %>
                                            <tr id="<%=code%>"><td><a href="album.jsp?id=<%=code%>" style="color:black; text-decoration: none"><%=rs.getString("category_name")%></td><td><a href="edit_category.jsp?code=<%=code%>" class="fas fa-edit" rel="<%=code%>" style="color:red"></a></td><td><i class="fa fa-trash" rel="<%=code%>" style="color:red"></i></td></tr>
                                        <%        
                                        }
                                        cn.close();
                                         }
