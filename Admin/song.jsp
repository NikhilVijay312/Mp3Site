        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-4 text-gray-800">Album:-<%=rs1.getString("album")%></h1>
                    <div class="col-sm-12">
                        <%
                                        }
                        %>
                        ...
                        %>
                        <div class="aleart alert-success">Song Added</div>
                        
                        <%
                        }
                        if(request.getParameter("exist")!=null){
                         %>
                         <div class="aleart alert-danger">Song Exist</div>
                         <%
                        }
                         %>
                         <%
                        ...
                        %>
                        <div class="aleart alert-info">Fill The Song Name</div>
                        
                        <%
                        }
                        %>
                        <form method="post" action="add_song.jsp?album_code=<%=album_code%>">
                    <label> Title:</label>
                    ...
                    <input type="submit" class="btn btn-danger">
                                    ...
                                    <div class="col-sm-12">
                                        ...
                                        while(rs.next()){  
                                            String code=rs.getString("album_code");
                                            %>
                                            <tr id="<%=code%>"><td><a href="album.jsp?id=<%=code%>" style="color:black; text-decoration: none"><%=rs.getString("song_title")%></td>
                                                <td><a href="edit_song_name.jsp?id=<%=code%>" class="fas fa-edit"  style="color:red"></a></td><td><i class="fa fa-trash" rel="<%=code%>" style="color:red"></i></td></tr>
                                        <%        
                                        }
                                        cn.close();
                                         }
