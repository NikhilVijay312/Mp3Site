<%-- 
    Document   : album
    Created on : Dec 29, 2020, 1:43:23 PM
    Author     : Nikhil Vijay
--%>
            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="cards.html">Cards</a>                    </div>
                </div>
            </li>
            ...
            <li class="nav-item">
                ...
                <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="utilities-other.html">Other</a>                    </div>
                </div>
            </li>
            ...
            <li class="nav-item active">
                ...
                <div id="collapsePages" class="collapse show" aria-labelledby="headingPages"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item active" href="blank.html">Blank Page</a>                    </div>
                </div>
            </li>
            ...
            <div id="content">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow mx-1">
                            ...
                            <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                ...
                                <a class="dropdown-item text-center small text-gray-500" href="#">Show All Alerts</a>                            </div>
                        </li>
                ...
                <div class="container-fluid">
                    ...
                    <div class="col-sm-12">
                        ...
                        %>
                        <div class="aleart alert-success">Category Added</div>
                        
                        <%
                        }
                        if(request.getParameter("exist")!=null){
                         %>
                         <div class="aleart alert-danger">Category Exist</div>
                         <%
                        }
                         %>
                         <%
                        ...
                        %>
                        <div class="aleart alert-info">Fill The Category Name</div>
                        
                        <%
                        }
                        %>
                        <form method="post" action="add_album.jsp?id=<%=id%>">
                    <label> Album:</label>
                    <input type="text" name="album" class="form-control" required><br>
                    <label> Description:</label>
                    <textarea  name="des" rows="4" class="form-control" required></textarea><br>
                    ...
                    <input type="submit" class="btn btn-danger">
                                    ...
                                    <div class="col-sm-12">
                                        ...
                                        while(rs.next()){  
                                            ...
                                            <tr id="<%=code%>"><td><a href="song.jsp?album_code=<%=code%>" style="color:black; text-decoration: none"><%=rs.getString("album")%></td>
                                                <td><a  class="fa fa-edit"  style="color:red" href="edit_album_name.jsp?album_code=<%=code%>" </a></td><td><i class="fa fa-trash" rel="<%=code%>" style="color:red"></i></td></tr>
                                        <%        
                                        }
                                        cn.close();
                                         }
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; Your Website 2020</span>                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
        </div>
