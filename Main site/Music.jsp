                    ...
                    <ul class="nav nav-pills nav-stacked custom-nav">
                        ...
                        <li class="menu-list"><a href="browse.html"><i class="lnr lnr-indent-increase"></i> <span>Browser</span></a>  
                            <ul class="sub-menu-list">
                                <li><a href="album.jsp">Artists</a> </li>
                            </ul>
                        </li>
                    ...
                    <div class="inner-content single">
                        ...
                        <div class="single_left">
                            <!--/video-main-->
                                      ...
                                      <source src="video/Ellie-Goulding.webm" type="audio/mpeg">
                        ...
                        <div class="coment-form">
                            ...
                            <form action="#" method="post">
                                ...
                                <input type="email" value="Email (will not be published)*" onfocus="this.value = '';" onblur="if (this.value == '') {
